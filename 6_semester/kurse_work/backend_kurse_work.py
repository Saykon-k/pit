...
def main(connection_from_user, info_about_work, info_about_faster_work, alfa, money, max_user_time, min_user_time, file_name):
    ...
    to_excel_data(file_name,connection_from_user, ranked_info, info_about_work, info_about_faster_work, alfa, opt_1)

def to_excel_data(file_name,connection_from_user,ranked_info,  info_about_work, info_about_faster_work, alfa, opt_1):
    print(connection_from_user)
    print(ranked_info)
    ...
    ws5 = wb2['ОПТ №1']
    opt_v1(ws5,ranked_info,connection_from_user, info_about_work,info_about_faster_work,alfa, opt_1)
...
def opt_v1(ws5,ranked_info,connection_from_user, info_about_work,info_about_faster_work,alfa, opt_1):
    k = 2
    for i in opt_1[1]:
        ws5[f'A{k}'].value = i
        k += 1
