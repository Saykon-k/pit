...
def bezie(p0, p1, p2, p3):
	...
	for i in range(101):
		t = i / 100
		#Bx = int((1-t)*(1-t)*p0[0]+2*(1-t)*t*p1[0]+t*t*p2[0])
		#By = int((1-t)*(1-t)*p0[1]+2*(1-t)*t*p1[1]+t*t*p2[1])
...
image = Image.open("F:/pit/4 semestr/comp_grafic/3_lab/files/roof_half.JPG") #Открываем изображение
...
#circle 3 points
#bezie((width//3,height//2), (width//2,0), (width*2//3,height//2), (width//2,height*3//4))
#bezie((width//3,height//2), (width//2,height), (width*2//3,height//2), (width//2,height*3//4))
#circele 4 points
...
#infinity
#bezie((width//2,0), (width,0), (0,height), (width//2,height))
#bezie((width//2,0), (0,0), (width,height), (width//2,height))
#bow
...
bezie((width//2, height//8), (width*3//4, height//8), (width*11//16, height*5//8), (width*7//16, height*3//4))
bezie((width*9//16, height*7//16), (width*9//16, height*7//16), (width*9//16, height*9//16), (width*7//16, height*3//4))
image.show()
#image.save("F:/pit/4 semestr/comp_grafic/3_lab/files")
del draw